...
R[0] = np.array([ # Rewards for action: UP = R[0]
    [0, 0, 0, 1], # rewards by Up from state (0,0)
    [0, 0, 0, 1], # rewards by Up from state (0,1)
    [0, 0, 0, 1], # rewards by Up from state (1,0)
    [0, 0, 0, 1]]) # rewards by Up from state (1,1)
R[1] = np.array([ # Rewards for action: DOWN = R[1]
    [0, 0, 0, 1], # rewards by Down from state (0,0)
    [0, 0, 0, 1], # rewards by Down from state (0,1)
    [0, 0, 0, 1], # rewards by Down from state (1,0)
    [0, 0, 0, 1]]) # rewards by Down from state (1,1)
R[2] = np.array([ # Rewards for action: LEFT = R[2]
    [0, 0, 0, 1], # rewards by Left from state (0,0)
    [0, 0, 0, 1], # rewards by Left from state (0,1)
    [0, 0, 0, 1], # rewards by Left from state (1,0)
    [0, 0, 0, 1]]) # rewards by Left from state (1,1)
R[3] = np.array([ # Rewards for action: RIGHT = R[3]
    [0, 0, 0, 1], # rewards by Right from state (0,0)
    [0, 0, 0, 1], # rewards by Right from state (0,1)
    [0, 0, 0, 1], # rewards by Right from state (1,0)
    [0, 0, 0, 1]]) # rewards by Right from state (1,1)
